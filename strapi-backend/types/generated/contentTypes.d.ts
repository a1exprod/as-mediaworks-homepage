...
export interface ApiFeaturedprojectFeaturedproject
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::featuredproject.featuredproject'
    > &
      Schema.Attribute.Private;
...
export interface ApiGraphicdesignGraphicdesign
  extends Struct.CollectionTypeSchema {
  collectionName: 'graphicdesigns';
  info: {
    displayName: 'graphicdesign';
    pluralName: 'graphicdesigns';
    singularName: 'graphicdesign';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::graphicdesign.graphicdesign'
    > &
      Schema.Attribute.Private;
    projects: Schema.Attribute.Relation<'oneToMany', 'api::project.project'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiLinkedInBlogLinkedInBlog
  extends Struct.CollectionTypeSchema {
  collectionName: 'linked_in_blogs';
  info: {
    description: '';
    displayName: 'LinkedInBlog';
    pluralName: 'linked-in-blogs';
    singularName: 'linked-in-blog';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::linked-in-blog.linked-in-blog'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::project.project'
    >;
    mediafiles: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    > &
      Schema.Attribute.SetPluginOptions<{
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::featuredproject.featuredproject': ApiFeaturedprojectFeaturedproject;
      'api::global.global': ApiGlobalGlobal;
      'api::graphicdesign.graphicdesign': ApiGraphicdesignGraphicdesign;
      'api::linked-in-blog.linked-in-blog': ApiLinkedInBlogLinkedInBlog;
