var api = "http://localhost:1337/api/featuredProjects?populate[projects][populate]=thumbnail";
...
fetch(api)
  ...
  .then(data => {
    ...
    const featuredProjectsContainer = document.getElementById('featuredProjects-container');

    if (data && data.data) {
      // Gehe durch alle FeaturedProjects-Einträge und deren zugehörige Projekte
      ...
      console.error('No featured projects data found.');
    }
  })
  .catch(error => {
